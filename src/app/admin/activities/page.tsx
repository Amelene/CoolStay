          ...
          {activities.map((activity) => (
            ...
            >
              <div className="relative h-48 w-full">
                <Image
                  src={activity.image_url || "/images/background/coolstaybg.png"}
                  alt={activity.name}
                  fill
                  className="object-cover transition-transform duration-500 group-hover:scale-110"
                />
                <div className="absolute inset-0 bg-gradient-to-t from-[#0A1A44]/80 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
                {selectedActivityId === activity.id && (
